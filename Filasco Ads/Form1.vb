...
Corporate Office: 47th street, Suite B3, Brooklyn, NY 11220"
    ...
    Private Sub Label2_Click(sender As Object, e As EventArgs) Handles lblGlobalVoipUser.Click
        Clipboard.SetText(lblGlobalVoipUser.Text)
    End Sub

    Private Sub Label3_Click(sender As Object, e As EventArgs) Handles lblGlobalVoipPass.Click
        Clipboard.SetText(lblGlobalVoipPass.Text)
    End Sub
    ...
    Private Sub Button1_Click_3(sender As Object, e As EventArgs) Handles btnSaveAds.Click
        If MsgBox("Are you sure to insert?", MsgBoxStyle.YesNo, Title:="Notice") = vbYes Then
            mycmd.Connection = myconnection.open
            mycmd.CommandText = "insert into attempt_to_registration (User_Name,Comments,Email)
            values('" & txtSubject.Text & "','" & txtBody.Text & "','" & cmbUser.Text & "')"
    ...
    Private Sub reload()
        ...
        txtBody.Text = Nothing
        ComboBoxSubject.Text = Nothing
        Try
            Dim query As String
            Mysqlconn = myconnection.open
            query = "select * from attempt_to_registration where Email  = '" & cmbUser.Text & "'"
    ...
    Private Sub cmbUser_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbUser.SelectedIndexChanged
        If cmbUser.Text = "Daniel" Then
            lblGlobalVoipUser.Text = "DANIEL MILLER"
            lblGlobalVoipPass.Text = "globalvoip1234"

            'lblVoipHelpUser.Text = ""
            'lblVoipHelpPass.Text = ""

            lblBestVoipUser.Text = "Daniel Miller"
            lblBestVoipPass.Text = "DANIEL1234"

            lblVoipTrafficUser.Text = "Daniel Miller"
            lblVoipTrafficPass.Text = "DANIEL1234"
        ElseIf cmbUser.Text = "Aaron" Then
            lblGlobalVoipUser.Text = "sales3@filasco.net"
            lblGlobalVoipPass.Text = "RF01682508910"

            lblVoipHelpUser.Text = "Aaron Fisher"
            lblVoipHelpPass.Text = "7E7GJ62XG98UE"

            lblBestVoipUser.Text = "Aaron Fisher"
            lblBestVoipPass.Text = "RF01682508910"

            'lblVoipTrafficUser.Text = ""
            'lblVoipTrafficPass.Text = ""
        ElseIf cmbUser.Text = "Roger" Then
            lblGlobalVoipUser.Text = "Roger Perez"
            lblGlobalVoipPass.Text = "SH01712263176"

            lblVoipHelpUser.Text = "Roger Perez"
            lblVoipHelpPass.Text = "SH01712263176"

            lblBestVoipUser.Text = "Roger Perez"
            lblBestVoipPass.Text = "SH01712263176"
